...
export default function RootClientLayout({ children }: { children: React.ReactNode }) {
  ...
  if (typeof window !== "undefined" && window.location.pathname.startsWith("/drogariasporto")) {
    return <>{children}</>;
  }
  if (typeof window !== "undefined" && window.location.pathname.startsWith("/jurisos")) {
    return <>{children}</>;
  }
if (typeof window !== "undefined" && window.location.pathname.startsWith("/revista/temaquinobairro")) {
    return <>{children}</>;
  }
  if (typeof window !== "undefined" && window.location.pathname.startsWith("/drivecontrol")) {
    return <>{children}</>;
  }
