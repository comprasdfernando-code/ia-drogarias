...
export default function Page() {
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      >
        <div className="mx-auto max-w-[1500px] px-4 pb-20 pt-14 md:px-8 md:pb-24 md:pt-24">
          <div className="max-w-4xl">
            ...
            <p className="mt-4 text-xl font-light md:text-4xl">
              São Mateus - SP
            </p>

            <p className="mt-5 max-w-2xl text-base text-white/90 md:text-xl">
      ...
      <section className="mx-auto mt-8 max-w-[1320px] px-4 md:mt-10 md:px-6">
        <div className="rounded-3xl bg-[#06142d] p-5 text-white shadow-xl md:flex md:items-center md:justify-between md:p-7">
          ...
          <a
            ...
            className="mt-5 block rounded-xl bg-yellow-400 px-6 py-4 text-center font-black text-slate-950 md:mt-0 md:inline-block"
          >
            Cadastrar Comércio
          </a>
        </div>
      ...
      <section className="mx-auto mt-8 grid max-w-[1320px] gap-5 px-4 pb-16 md:mt-10 md:grid-cols-3 md:px-6">
        {promocoes.map((p) => (
          <div
            key={p.titulo}
            className={`${p.cor} rounded-3xl p-6 text-white shadow-xl`}
          >
