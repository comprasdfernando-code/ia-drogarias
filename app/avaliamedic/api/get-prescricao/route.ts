...
export async function GET(req: Request) {
  ...
  // Buscar os itens analisados da prescrição
  ...
  // Montar estrutura esperada pelo front
  return NextResponse.json({
    prescricao,
    relatorio: itens,   // <-- AQUI O FRONT-CEND CONSEGUE LER
  });
}